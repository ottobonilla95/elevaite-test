...
export function PdfDisplay(props: PdfDisplayProps): JSX.Element {
  ...
  function formatPdfData(fileReference: Blob): void {
  ...
  function handleTabSelection(passedTab: CONTRACT_TYPES): void {
    ...
    //     if (
    //       props.contract.content_type !== CONTRACT_TYPES.INVOICE &&
    //       props.contract.verification?.invoice?.[0]?.file_id
    //     )
    //       contractsContext.setSelectedContractById(
    ...
    //     if (
    //       props.contract.content_type !== CONTRACT_TYPES.PURCHASE_ORDER &&
    //       props.contract.verification?.po?.[0]?.file_id
    //     )
    //       contractsContext.setSelectedContractById(
    ...
    //     if (
    //       props.contract.content_type !== CONTRACT_TYPES.VSOW &&
    //       props.contract.verification?.vsow?.[0]?.file_id
    //     )
    //       contractsContext.setSelectedContractById(
    ...
    //     if (
    //       props.contract.content_type !== CONTRACT_TYPES.CSOW &&
    //       props.contract.verification?.csow?.[0]?.file_id
    //     )
    //       contractsContext.setSelectedContractById(
