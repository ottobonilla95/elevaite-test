...
if (AWS_AKID === undefined) throw new Error("AWS Access Key ID is not present in the environment");

const AWS_SAK = process.env.AWS_SAK
if (AWS_SAK === undefined) throw new Error("AWS Secret Access Key is not present in the environment");

const AWS_BUCKET_NAME = process.env.AWS_BUCKET_NAME
if (AWS_BUCKET_NAME === undefined) throw new Error("AWS Bucket Name is not present in the environment");
