...
const appLinks: Record<string, { development: string; production: string; test: string }> = {
  ...
  documentExtraction: {
    development: "https://elevaite-ap.iopex.ai/prompt",
    production: "https://elevaite-ap.iopex.ai/prompt",
    test: "",
  },
  mediaplan: {
  ...
  contentIntelligence: {
    development: "https://unilever-poc.growatiopex.com/",
    production: "https://unilever-poc.growatiopex.com/",
    test: "",
  },
  contractCompliance: {
    development: "https://elevaite-acm.iopex.ai",
    production: "https://elevaite-acm.iopex.ai",
    test: "",
  }
};
...
export function getApplications(
  ...
  return [
      ...
      cards: [
        {
          ...
          title: "Media & Marketing Command Agents",
        ...
        },
        {
          ...
          title: "Media & Marketing Workflow",
        ...
        },
        {
          ...
          title: "Command Agents Analytics",
        ...
        {
          icon: ApplicationIcons.applications.contentIntelligence.src,
          description: "Agentic workflows to enforce brand consistency, maximize impact, and deliver competitive intelligence.",
          iconAlt: ApplicationIcons.applications.contentIntelligence.alt,
          title: "Content Intelligence",
          link: appLinks.contentIntelligence[env],
      ...
      cards: [
        {
          ...
          description: "Your AI-powered assistant guiding you through setup, troubleshooting, and product-related queries.",
          iconAlt: ApplicationIcons.applications.arloSupport.alt,
          title: "Support - Command Agent",
        ...
        {
          icon: ApplicationIcons.applications.analytics.src,
          description: "Gain actionable insights and analytics to monitor Support Agents effectiveness and optimize performance",
          iconAlt:  ApplicationIcons.applications.analytics.alt,
          title: "Support Agents Analytics (Cx)",
        ...
        },
        {
          ...
          description: "View key sentiment insights for your CX Support performance.",
          iconAlt: ApplicationIcons.applications.logsSupport.alt,
          title: "Sentiments Insights (Cx)",
    ...
    },   
    {
      ...
      cards: [
        ...
        // },
        {
          ...
          description: "Extract, validate and approve invoices against contracts and PO's",
        ...
        {
          icon: ApplicationIcons.applications.contracts.src,
          description: "Configure, test and publish key information from your documents.",
          iconAlt: ApplicationIcons.applications.contracts.alt,
          title: "Document Configuration",
          link: appLinks.documentExtraction[env],
	...
	{
          icon: ApplicationIcons.applications.contracts.src,
          description: "Ensure contract compliance and spot deviations early across suppliers, partners, and customers.",
          iconAlt: ApplicationIcons.applications.contracts.alt,
          title: "Contract Management & Assurance",
          link: appLinks.contractCompliance[env],
          id: "contractCompliance",
          miscLabel: "Version 1.0",
          subtitle: "By Elevaite",
          openInNewTab: true,
        },
