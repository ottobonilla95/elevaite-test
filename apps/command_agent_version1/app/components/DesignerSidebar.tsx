...
import { AgentResponse, SavedWorkflow, ToolInfo } from "../lib/interfaces";
                ...
                <div className="text-black">
                    {
                        isOpen ?
                            <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 1L5 5L9 1" stroke="#212124" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            :
                            <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 5L5 1L9 5" stroke="#212124" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                    }
                </div>
            </div>
...
const DesignerSidebar: React.FC<DesignerSidebarProps> = ({
    ...
    const getToolIcon = (tool: ToolInfo) => {
    ...
    const getToolIconClass = (tool: ToolInfo) => {
        const name = tool.name.toLowerCase();
        const description = tool.description.toLowerCase();
        ...
        switch (type) {
            case "router":
                return <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M15.8706 13.7061C15.8706 13.7061 14.2471 15.8708 11 15.8708C7.75293 15.8708 6.12939 13.7061 6.12939 13.7061" stroke="#FE854B" strokeWidth="1.62354" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M7.21159 8.83529C6.91271 8.83529 6.67041 8.59299 6.67041 8.29411C6.67041 7.99523 6.91271 7.75293 7.21159 7.75293C7.51047 7.75293 7.75277 7.99523 7.75277 8.29411C7.75277 8.59299 7.51047 8.83529 7.21159 8.83529Z" fill="#FE854B" stroke="#FE854B" strokeWidth="1.62354" stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <SidebarItem
                            icon={
                                <div className="w-8 h-8 rounded-md bg-purple-100 flex items-center justify-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g opacity="0.8">
                                            <path d="M10.5004 11.9998H5.00043M4.91577 12.2913L2.58085 19.266C2.39742 19.8139 2.3057 20.0879 2.37152 20.2566C2.42868 20.4031 2.55144 20.5142 2.70292 20.5565C2.87736 20.6052 3.14083 20.4866 3.66776 20.2495L20.3792 12.7293C20.8936 12.4979 21.1507 12.3822 21.2302 12.2214C21.2993 12.0817 21.2993 11.9179 21.2302 11.7782C21.1507 11.6174 20.8936 11.5017 20.3792 11.2703L3.66193 3.74751C3.13659 3.51111 2.87392 3.39291 2.69966 3.4414C2.54832 3.48351 2.42556 3.59429 2.36821 3.74054C2.30216 3.90893 2.3929 4.18231 2.57437 4.72906L4.91642 11.7853C4.94759 11.8792 4.96317 11.9262 4.96933 11.9742C4.97479 12.0168 4.97473 12.0599 4.96916 12.1025C4.96289 12.1506 4.94718 12.1975 4.91577 12.2913Z" stroke="#FF681F" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </g>
                                    </svg>
                                </div>
                            }
                        ...
                        <SidebarItem
                            icon={
                                <div className="w-8 h-8 rounded-md bg-green-100 flex items-center justify-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g opacity="0.8">
                                            <path d="M21 12L9 12M21 6L9 6M21 18L9 18M5 12C5 12.5523 4.55228 13 4 13C3.44772 13 3 12.5523 3 12C3 11.4477 3.44772 11 4 11C4.55228 11 5 11.4477 5 12ZM5 6C5 6.55228 4.55228 7 4 7C3.44772 7 3 6.55228 3 6C3 5.44772 3.44772 5 4 5C4.55228 5 5 5.44772 5 6ZM5 18C5 18.5523 4.55228 19 4 19C3.44772 19 3 18.5523 3 18C3 17.4477 3.44772 17 4 17C4.55228 17 5 17.4477 5 18Z" stroke="#FF681F" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </g>
                                    </svg>
                                </div>
                            }
                            ...
                            icon={
                                <div className="w-8 h-8 rounded-md bg-amber-100 flex items-center justify-center">
                                    <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10 8.5V12.5L12.5 14M10 4C5.30558 4 1.5 7.80558 1.5 12.5C1.5 17.1944 5.30558 21 10 21C14.6944 21 18.5 17.1944 18.5 12.5C18.5 7.80558 14.6944 4 10 4ZM10 4V1M8 1H12M18.329 4.59204L16.829 3.09204L17.579 3.84204M1.67102 4.59204L3.17102 3.09204L2.42102 3.84204" stroke="#FF681F" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                            }
                            label="Delay"
