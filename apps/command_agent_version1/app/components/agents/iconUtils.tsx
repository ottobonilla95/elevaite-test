...
// Get icon for highlighted agents
export function getHighlightedAgentIcon(agentName: string): JSX.Element {
  switch (agentName.toLowerCase()) {
    case "vectorizer":
      return <Layers size={20} className="text-brand-primary" />;
    default:
      return <Zap size={20} className="text-brand-primary" />;
  }
}
