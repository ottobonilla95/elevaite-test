				...
				{activeTab === "tab1" && (
					<div className="tab-panel">
							...
							<div className="actions-wrapper flex items-center justify-between">
								<div className="flex gap-2 font-medium items-center">
									<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
										<g opacity="0.64">
											<path d="M10.3333 3.99996C10.7015 3.99996 11 3.70148 11 3.33329C11 2.9651 10.7015 2.66663 10.3333 2.66663C9.96514 2.66663 9.66667 2.9651 9.66667 3.33329C9.66667 3.70148 9.96514 3.99996 10.3333 3.99996Z" stroke="#212124" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
											<path d="M10.3333 8.66663C10.7015 8.66663 11 8.36815 11 7.99996C11 7.63177 10.7015 7.33329 10.3333 7.33329C9.96514 7.33329 9.66667 7.63177 9.66667 7.99996C9.66667 8.36815 9.96514 8.66663 10.3333 8.66663Z" stroke="#212124" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
											<path d="M10.3333 13.3333C10.7015 13.3333 11 13.0348 11 12.6666C11 12.2984 10.7015 12 10.3333 12C9.96514 12 9.66667 12.2984 9.66667 12.6666C9.66667 13.0348 9.96514 13.3333 10.3333 13.3333Z" stroke="#212124" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
											<path d="M5.66667 3.99996C6.03486 3.99996 6.33333 3.70148 6.33333 3.33329C6.33333 2.9651 6.03486 2.66663 5.66667 2.66663C5.29848 2.66663 5 2.9651 5 3.33329C5 3.70148 5.29848 3.99996 5.66667 3.99996Z" stroke="#212124" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
											<path d="M5.66667 8.66663C6.03486 8.66663 6.33333 8.36815 6.33333 7.99996C6.33333 7.63177 6.03486 7.33329 5.66667 7.33329C5.29848 7.33329 5 7.63177 5 7.99996C5 8.36815 5.29848 8.66663 5.66667 8.66663Z" stroke="#212124" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
											<path d="M5.66667 13.3333C6.03486 13.3333 6.33333 13.0348 6.33333 12.6666C6.33333 12.2984 6.03486 12 5.66667 12C5.29848 12 5 12.2984 5 12.6666C5 13.0348 5.29848 13.3333 5.66667 13.3333Z" stroke="#212124" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
										</g>
									</svg>
									Invoice Extractor
								</div>
								...
								<div className="flex items-center gap-3">
									<button>
										<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M16.4001 17H6.60012C6.26875 17 6.00012 16.7314 6.00012 16.4001V6.60012C6.00012 6.26875 6.26875 6.00012 6.60012 6.00012H16.4001C16.7314 6.00012 17 6.26875 17 6.60012V16.4001C17 16.7314 16.7314 17 16.4001 17Z" stroke="#4D4D50" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
											<path d="M11.9999 5.99997V1.6C11.9999 1.26863 11.7313 1 11.3999 1H1.6C1.26863 1 1 1.26863 1 1.6V11.3999C1 11.7313 1.26863 11.9999 1.6 11.9999H5.99997" stroke="#4D4D50" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
										</svg>
									</button>
									<button>
										<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
											<g opacity="0.8" clipPath="url(#clip0_1120_5351)">
												<path d="M14 14H8.66664M1.66663 14.3334L5.36614 12.9105C5.60277 12.8195 5.72108 12.774 5.83177 12.7146C5.93009 12.6618 6.02383 12.6009 6.11199 12.5324C6.21124 12.4554 6.30088 12.3658 6.48015 12.1865L14 4.66671C14.7364 3.93033 14.7364 2.73642 14 2.00004C13.2636 1.26366 12.0697 1.26366 11.3333 2.00004L3.81348 9.51985C3.63421 9.69912 3.54457 9.78876 3.46755 9.88801C3.39914 9.97617 3.33823 10.0699 3.28545 10.1682C3.22603 10.2789 3.18053 10.3972 3.08951 10.6339L1.66663 14.3334ZM1.66663 14.3334L3.03871 10.766C3.13689 10.5107 3.18598 10.3831 3.27019 10.3246C3.34377 10.2735 3.43483 10.2542 3.52282 10.271C3.62351 10.2902 3.72021 10.3869 3.91361 10.5803L5.41967 12.0864C5.61307 12.2798 5.70977 12.3765 5.729 12.4772C5.74581 12.5652 5.72648 12.6562 5.67539 12.7298C5.61692 12.814 5.48928 12.8631 5.23401 12.9613L1.66663 14.3334Z" stroke="#212124" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
											</g>
											<defs>
						...
						<div className="part py-4">
							...
							<div className="tags flex flex-wrap gap-3">
								<div className="tag">meta-llama/Llama-3.1-8B</div>
							</div>
						</div>
						{/* <div className="part py-4">
