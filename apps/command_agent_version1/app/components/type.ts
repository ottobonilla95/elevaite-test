...
import { AGENT_TYPE, type AgentType, type AgentNodeData } from "../lib/interfaces";
...
export const AGENT_STYLES: Record<AgentType, { bgClass: string; textClass: string }> = {
    ...
    [AGENT_TYPE.WEB_SEARCH]: { bgClass: "bg-emerald-100", textClass: "text-emerald-600" },
    [AGENT_TYPE.WEATHER_SEARCH]: { bgClass: "bg-amber-100", textClass: "text-amber-600" },
    [AGENT_TYPE.DATA]: { bgClass: "bg-purple-100", textClass: "text-purple-600" },
    [AGENT_TYPE.TROUBLESHOOTING]: { bgClass: "bg-red-100", textClass: "text-red-600" },
