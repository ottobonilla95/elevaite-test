			...
			<button onClick={() => toggleColStatus(!isColExpanded)}>
				{isColExpanded ? (
					<svg width="17" height="48" viewBox="0 0 17 48" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M2.83333 25.4167H7.08333M7.08333 25.4167V29.6667M7.08333 25.4167L2.125 30.375M14.1667 22.5833H9.91667M9.91667 22.5833V18.3333M9.91667 22.5833L14.875 17.625" stroke="#4D4D50" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
					</svg>
				) : (
