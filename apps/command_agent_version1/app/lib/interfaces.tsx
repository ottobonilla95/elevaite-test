...
// Tools-related interfaces - Database-backed system

// New comprehensive tool interface matching backend ToolResponse
export interface Tool {
    ...
    execution_type: string; // function, api, command
...
// Tool Category interfaces - matching backend ToolCategoryResponse
...
// MCP Server interfaces - matching backend MCPServerResponse
...
// Tool execution interfaces - matching backend schemas
