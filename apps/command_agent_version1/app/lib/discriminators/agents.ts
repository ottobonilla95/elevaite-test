import { AGENT_TYPE, type AgentResponse, type AgentType } from "../interfaces/agents";
...
export function isValidAgentType(type: unknown): type is AgentType {
	return type !== null && Object.values(AGENT_TYPE).includes(type as AgentType);
}
