...
class TestTenantMiddleware:
    ...
    def test_invalid_tenant_id(self, multitenancy_settings):
        ...
        response = client.get(
            "/test-invalid-tenant", headers={"X-Tenant-ID": "invalid@tenant"}
        )
    ...
    def test_tenant_callback(self, multitenancy_settings):
        ...
        response1 = client.get(
            "/test-tenant-callback", headers={"X-Tenant-ID": "valid-tenant"}
        )
        ...
        response2 = client.get(
            "/test-tenant-callback", headers={"X-Tenant-ID": "tenant1"}
        )
