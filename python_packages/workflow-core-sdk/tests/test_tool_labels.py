...
def test_google_style_with_types():
    ...
    assert params["include_metadata"]["description"] == "Whether to include metadata in results"
...
def test_real_world_example():
    ...
    assert params["num_results"]["description"] == "Number of search results to return (1-100)"
    
    assert params["search_engine"]["title"] == "Search Engine"
    assert params["search_engine"]["description"] == "Which search engine to use (google, bing, duckduckgo)"
