...
def test_step_connection_basic():
    ...
    connection = StepConnection(source_step_id="step-1", target_step_id="step-2")
...
def test_tool_override_basic():
    ...
    override = ToolOverride(
        title="Custom Tool Title", description="Custom tool description"
    )
...
def test_step_with_tool_override():
    ...
    step = StepBase(
        ...
        tool_override=ToolOverride(
            title="Welcome Email", description="Send welcome email to new user"
        ),
    )
...
def test_workflow_with_connections():
    ...
    workflow = WorkflowConfig(
        ...
        connections=[
            StepConnection(
                source_step_id="trigger-1", target_step_id="step-1", animated=True
            ),
            StepConnection(
                source_step_id="step-1",
                target_step_id="step-2",
...
def test_workflow_without_connections():
    ...
    workflow = WorkflowConfig(
        ...
        steps=[
            TriggerStepConfig(
                step_id="trigger-1", parameters=TriggerParameters(kind="webhook")
            ),
            StepBase(
                step_id="step-1",
                step_type="tool",
...
def test_workflow_json_serialization():
    ...
    workflow = WorkflowConfig(
        ...
        connections=[StepConnection(source_step_id="step-1", target_step_id="step-2")],
    )
