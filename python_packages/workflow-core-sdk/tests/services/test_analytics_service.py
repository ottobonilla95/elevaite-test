...
class TestRecordAgentExecution:
    ...
    def test_record_agent_execution_success(
        self, analytics_service, mock_session, sample_agent_output
    ):
    ...
    def test_record_agent_execution_without_step_id(
        self, analytics_service, mock_session, sample_agent_output
    ):
    ...
    def test_record_agent_execution_with_error(
        self, analytics_service, mock_session, sample_agent_output
    ):
    ...
    def test_record_agent_execution_redact_response(
        self, analytics_service, mock_session, sample_agent_output
    ):
        ...
        assert (
            added_metric.query == "What is the weather?"
        )  # Query should still be present

    def test_record_agent_execution_missing_usage(
    ...
    def test_record_agent_execution_missing_model(
        self, analytics_service, mock_session
    ):
    ...
    def test_record_agent_execution_fallback_agent_name(
        self, analytics_service, mock_session
    ):
    ...
    def test_record_agent_execution_default_agent_name(
        self, analytics_service, mock_session
    ):
...
class TestRecordWorkflowMetrics:
    ...
    def test_record_workflow_metrics_without_timestamps(
        self, analytics_service, mock_session
    ):
    ...
    def test_record_workflow_metrics_partial_timestamps(
        self, analytics_service, mock_session
    ):
    ...
    def test_record_workflow_metrics_without_workflow_name(
        self, analytics_service, mock_session
    ):
    ...
    def test_record_workflow_metrics_empty_summary(
        self, analytics_service, mock_session
    ):
