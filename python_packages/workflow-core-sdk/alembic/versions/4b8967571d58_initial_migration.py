...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("execution_id", sa.Uuid(), nullable=False),
        sa.Column(
            "step_id", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column("role", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False),
        sa.Column("content", sa.Text(), nullable=True),
        sa.Column("message_metadata", sa.JSON(), nullable=True),
        sa.Column(
            "user_id", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column(
            "session_id", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "decided_by", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "ai_model_provider", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "step_name", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column(
            "step_type", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
        sa.Column(
            "status",
            sa.Enum(
    ...
    op.create_table(
        ...
        sa.Column(
            "registered_by", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
