...
class StepRegistry:
    ...
    async def register_builtin_steps(self):
        ...
        await self.register_step(
            {
                ...
                "function_reference": "workflow_core_sdk.steps.trigger_steps.trigger_step",
        ...
        await self.register_step(
            {
                ...
                "function_reference": "workflow_core_sdk.steps.human_steps.human_approval_step",
                "execution_type": "local",
                "parameters_schema": {
                    "type": "object",
                    "properties": {
        ...
        await self.register_step(
            {
                ...
                "function_reference": "workflow_core_sdk.steps.data_steps.data_processing_step",
                "execution_type": "local",
                "parameters_schema": {
                    "type": "object",
                    "properties": {
        ...
        await self.register_step(
            {
                ...
                "function_reference": "workflow_core_sdk.steps.data_steps.data_merge_step",
                "execution_type": "local",
            }
        )
        ...
        await self.register_step(
            {
                ...
                "function_reference": "workflow_core_sdk.steps.ai_steps.agent_execution_step",
                "execution_type": "local",
                "parameters_schema": {
                    "type": "object",
                    "properties": {
        ...
        # NOTE: Using skip_on_error=True for file steps due to optional elevaite_ingestion dependency
        await self.register_step(
            {
                "step_type": "file_reader",
                "name": "File Reader",
                "description": "Reads and extracts content from various document formats (PDF, DOCX, XLSX, TXT)",
                "function_reference": "workflow_core_sdk.steps.file_steps.file_reader_step",
                "execution_type": "local",
                "parameters_schema": {
                    "type": "object",
                    "properties": {
        ...
        await self.register_step(
            {
                ...
                "function_reference": "workflow_core_sdk.steps.file_steps.text_chunking_step",
                "execution_type": "local",
                "parameters_schema": {
                    "type": "object",
                    "properties": {
        ...
        await self.register_step(
            {
                ...
                "function_reference": "workflow_core_sdk.steps.file_steps.embedding_generation_step",
                "execution_type": "local",
                "parameters_schema": {
                    "type": "object",
                    "properties": {
        ...
        await self.register_step(
            {
                ...
                "function_reference": "workflow_core_sdk.steps.file_steps.vector_storage_step",
                "execution_type": "local",
                "parameters_schema": {
                    "type": "object",
                    "properties": {
        ...
        await self.register_step(
            {
                ...
                "function_reference": "workflow_core_sdk.steps.file_steps.vector_search_step",
                "execution_type": "local",
                "parameters_schema": {
                    "type": "object",
                    "properties": {
        ...
        await self.register_step(
            {
                ...
                "function_reference": "workflow_core_sdk.steps.flow_steps.subflow_step",
                "execution_type": "local",
                "parameters_schema": {
                    "type": "object",
                    "properties": {
        ...
        await self.register_step(
            {
                ...
                "function_reference": "workflow_core_sdk.steps.tool_steps.tool_execution_step",
                "execution_type": "local",
                "parameters_schema": {
                    "type": "object",
                    "properties": {
