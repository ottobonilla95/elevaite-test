...
# Import error handling if it exists, otherwise stub it
try:
...
from workflow_core_sdk.services.analytics_service import analytics_service
from typing import TYPE_CHECKING

if TYPE_CHECKING:  # type-only import to avoid runtime dependency
    from workflow_core_sdk.execution.step_registry import StepRegistryProtocol
    ...
    async def _execute_single_step(
        ...
        try:
            ...
            if step_result.status == StepStatus.COMPLETED:
                ...
                try:
                    if step_type == "agent_execution" and isinstance(
