...
CHUNKER_CONFIG = {
    ...
    "available_chunkers": {
        ...
        "recursive_chunking": {
            "import_path": "elevaite_ingestion.chunk_strategy.standard_chunking.recursive_chunking",
            "function_name": "chunk_text",
            "settings": {"chunk_size": 500, "chunk_overlap": 50},
        },
        "sentence_chunking": {
            "import_path": "elevaite_ingestion.chunk_strategy.custom_chunking.sentence_chunking",
            "function_name": "chunk_text",
            "settings": {"max_chunk_size": 500},
        },
    },
}
