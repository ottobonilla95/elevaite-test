...
class TestCheckAccessHappyPath:
    ...
    def test_check_access_allowed(self, mock_post, sample_user_id, sample_action, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_denied(self, mock_post, sample_user_id, sample_action, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_with_custom_base_url(self, mock_post, sample_user_id, sample_action, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_strips_trailing_slash(self, mock_post, sample_user_id, sample_action, sample_resource):
...
class TestCheckAccessNetworkFailures:
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_connection_error(self, mock_post, sample_user_id, sample_action, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_timeout(self, mock_post, sample_user_id, sample_action, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_http_error_404(self, mock_post, sample_user_id, sample_action, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_http_error_500(self, mock_post, sample_user_id, sample_action, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_http_error_401(self, mock_post, sample_user_id, sample_action, sample_resource):
...
class TestCheckAccessMalformedResponses:
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_missing_allowed_field(self, mock_post, sample_user_id, sample_action, sample_resource):
        """Test that missing 'allowed' field defaults to False."""
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"deny_reason": "some_reason"}  # Missing 'allowed'
        mock_post.return_value = mock_response
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_empty_response(self, mock_post, sample_user_id, sample_action, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_invalid_json(self, mock_post, sample_user_id, sample_action, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_allowed_null(self, mock_post, sample_user_id, sample_action, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_allowed_string_true(self, mock_post, sample_user_id, sample_action, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_allowed_string_false(self, mock_post, sample_user_id, sample_action, sample_resource):
...
class TestCheckAccessEdgeCases:
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_negative_user_id(self, mock_post, sample_action, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_empty_action(self, mock_post, sample_user_id, sample_resource):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_empty_resource(self, mock_post, sample_user_id, sample_action):
    ...
    @patch("rbac_sdk.client.requests.post")
    def test_check_access_custom_timeout(self, mock_post, sample_user_id, sample_action, sample_resource):
