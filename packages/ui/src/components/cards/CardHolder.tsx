...
export function CardHolder(props: CardHolderProps) {
  ...
  return (
    <div className="cardHolderContainer" style={{ borderColor: colors.borderColor, background: colors.primary }}>
      ...
      >
        <button className="cardHolderTitleBtn" onClick={() => setHidden(!hidden)}>
...
const ChevronBottom = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={16} height={17} fill="none" {...props}>
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="m4 6.5 4 4 4-4" />
  </svg>
);
...
const Burger = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={25} fill="currentColor" {...props}>
    <path fill="#64748B" d="M3.2 18.5h18v-1.933h-18V18.5Zm0-4.833h18v-1.934h-18v1.934Zm0-6.767v1.933h18V6.9h-18Z" />
  </svg>
);
