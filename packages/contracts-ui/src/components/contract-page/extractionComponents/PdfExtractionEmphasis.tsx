...
export function PdfExtractionEmphasis(
  props: PdfExtractionEmphasisProps
): React.ReactNode {
  const [emphasisData, setEmphasisData] =
    ...
    <div className="pdf-extraction-emphasis-container">
      ...
      <div className="pdf-emphasis-block">
        <EmphasisBit
          ...
          valueKey="rec_charges"
        />
        <EmphasisBit
          emphasisData={emphasisData}
          label="Non-recurring Charges"
          valueKey="non_rec_charges"
        />
        <EmphasisBit
          emphasisData={emphasisData}
          label="Total Amount"
