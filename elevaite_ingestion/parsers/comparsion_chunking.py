...
if df_comparison.empty:
    ...
    ax.axis('tight')
    ax.axis('off')
    table = ax.table(cellText=placeholder_data, colLabels=columns, cellLoc='center', loc='center')

    plt.title("Comparison of Different Chunking Approaches (Placeholder Data)", fontsize=14, fontweight="bold")
    plt.show()
else:
    fig, ax = plt.subplots(figsize=(20, 10))
    ax.axis('tight')
    ...
    plt.title("Comparison of Different Chunking Approaches", fontsize=18, fontweight="bold")
    plt.show()
