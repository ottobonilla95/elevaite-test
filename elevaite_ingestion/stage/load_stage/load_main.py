...
from load_pipeline import load_files_to_destination, upload_file_to_s3
...
def execute_pipeline():
    ...
    status_file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "stage/load_stage/stage_1_status.json"))
