...
async def patch_user(
   ...
   user_to_patch: models.User = validation_info.get("user_to_patch", None)
   db: Session = validation_info.get("db", None)
...
async def patch_user_account_roles(
   ...
   user_to_patch_account_association: models.User_Account = validation_info.get("user_to_patch_account_association", None)
   db: Session = validation_info.get("db", None)
...
async def update_user_project_permission_overrides(
   ...
   permission_overrides_payload: role_schemas.ProjectScopedPermissions = Body(...),
