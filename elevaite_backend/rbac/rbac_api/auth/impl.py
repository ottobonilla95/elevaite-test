...
class AccessTokenOrApikeyAuthentication(AuthenticationInterface):
   ...
   async def authenticate(
      request: Request,
      access_token_header: Optional[str] = Header(None, alias='Authorization', description = "iDP access token with email and profile scope"),
      ...
      api_key_header: Optional[str] = Header(None, alias='X-elevAIte-apikey', description="API key for auth"),
      ...
      if (access_token_header and api_key_header) or (not access_token_header and not api_key_header):
