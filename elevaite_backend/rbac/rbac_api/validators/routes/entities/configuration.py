...
def validate_get_application_configuration_factory(
    ...
    async def validate_get_application_configuration(
        ...
        configuration_id: UUID = Path(
            ..., description="id of connector application configuration"
        ),
    ) -> dict[str, Any]:
        db: Session = request.state.db
        try:
            ...
            db.rollback()
            pprint(
                f"API error in GET /application/{application_id}/configuration/{configuration_id} - validate_get_connector_configuration middleware : {e}"
            )
            raise e
        except SQLAlchemyError as e:
            pprint(
                f"DB error in GET /application/{application_id}/configuration/{configuration_id} - validate_get_connector_configuration middleware : {e}"
            )
            request.state.source_error_msg = str(e)
            raise ApiError.serviceunavailable(
                "The server is currently unavailable, please try again later."
            ...
            db.rollback()
            print(
                f"Unexpected error in GET /application/{application_id}/configuration/{configuration_id} - validate_get_connector_configuration middleware : {e}"
            )
            request.state.source_error_msg = str(e)
            raise ApiError.serviceunavailable(
                "The server is currently unavailable, please try again later."
...
def validate_update_application_configuration_factory(
    ...
    async def validate_update_application_configuration(
        ...
        try:
            ...
            db.rollback()
            pprint(
                f"API error in PUT /application/{application_id}/configuration/{configuration_id} - validate_update_connector_configuration middleware : {e}"
            )
            raise e
        except SQLAlchemyError as e:
            pprint(
                f"DB error in PUT /application/{application_id}/configuration/{configuration_id} - validate_update_connector_configuration middleware : {e}"
            )
            request.state.source_error_msg = str(e)
            raise ApiError.serviceunavailable(
                "The server is currently unavailable, please try again later."
            ...
            db.rollback()
            print(
                f"Unexpected error in PUT /application/{application_id}/configuration/{configuration_id} - validate_update_connector_configuration middleware : {e}"
            )
            request.state.source_error_msg = str(e)
            raise ApiError.serviceunavailable(
                "The server is currently unavailable, please try again later."
...
def validate_create_application_configuration_factory(
    target_model_class: Type[models.Base], target_model_action_sequence: tuple[str, ...]
):
    @auditor.audit(api_namespace=api_schemas.APINamespace.RBAC_API)
    async def validate_create_application_configuration(
        ...
        try:
            ...
            db.rollback()
            pprint(
                f"API error in POST /application/{application_id}/configuration - validate_create_connector_configuration middleware : {e}"
            )
            raise e
        except SQLAlchemyError as e:
            pprint(
                f"DB error in POST /application/{application_id}/configuration - validate_create_connector_configuration middleware : {e}"
            )
            request.state.source_error_msg = str(e)
            raise ApiError.serviceunavailable(
                "The server is currently unavailable, please try again later."
            ...
            db.rollback()
            print(
                f"Unexpected error in POST /application/{application_id}/configuration - validate_create_connector_configuration middleware : {e}"
            )
            request.state.source_error_msg = str(e)
            raise ApiError.serviceunavailable(
                "The server is currently unavailable, please try again later."
