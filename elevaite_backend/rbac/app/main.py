...
from app.routes.main import attach_routes
import uvicorn
from elevaitedb.db.database import engine
from elevaitedb.db import models
from app.utils.seed_db import seed_db as seed
...
# In production, you should use Uvicorn or Gunicorn with Uvicorn workers from the command line
