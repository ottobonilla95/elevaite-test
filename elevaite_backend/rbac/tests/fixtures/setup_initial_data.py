...
def setup_initial_data(test_session):
   ...
   test_session.add_all([organization,
                           user1, user2, user3, user4, user5,
                           account1, account2, account3, account4, account5, default_account,
                           user1_default_account, user2_default_account, user3_default_account, user4_default_account, user5_default_account, user2_account2, user3_account2, user3_account4, user4_account2, user4_account4, user4_account5, user5_account4, user5_account5,
                           project1, project2, project3, project4,
                           user1_project1, user1_project2, user1_project3, user1_project4, user2_project1, user2_project2, user2_project3, user2_project4, user4_project1,
                           role1, role2, role3
                        ])
   test_session.commit()
   yield
