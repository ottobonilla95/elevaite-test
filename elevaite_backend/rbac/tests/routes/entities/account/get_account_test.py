...
async def test_get_account_with_existing_account_id_and_valid_access_token_not_in_redis_cache_and_authenticating_user_is_superadmin(mock_requests, mock_redis_class, client, setup_initial_data):
...
@patch("rbac_api.auth.impl.RedisSingleton")
@patch("rbac_api.auth.idp.impl.requests")
async def test_get_account_with_existing_account_id_and_valid_access_token_in_redis_cache_and_authenticating_user_is_superadmin(mock_requests, mock_redis_class, client, setup_initial_data):
  ...
  # Mock the GoogleIDP request.get method
   ...
   response = await client.request(
      method="GET",
      url=f'/accounts/{existing_account_id}',
      headers=headers,
   )
...
@pytest.mark.asyncio
@patch("rbac_api.auth.impl.RedisSingleton")
async def test_get_account_with_existing_account_id_and_valid_access_token_and_authenticating_user_is_not_superadmin_and_is_assigned_to_account(mock_redis_class, client, setup_initial_data):
...
@pytest.mark.asyncio
@patch("rbac_api.auth.impl.RedisSingleton")
async def test_get_account_with_existing_account_id_and_valid_access_token_and_authenticating_user_is_not_superadmin_and_is_not_assigned_to_account(mock_redis_class, client, setup_initial_data):
...
@pytest.mark.asyncio
async def test_get_account_with_existing_account_id_and_no_access_token(client, setup_initial_data):
...
@patch("rbac_api.auth.impl.RedisSingleton")
@patch("rbac_api.auth.idp.impl.requests")
async def test_get_account_with_existing_account_id_and_invalid_or_expired_access_token(mock_requests, mock_redis_class, client, setup_initial_data):
...
@pytest.mark.asyncio
@patch("rbac_api.auth.impl.RedisSingleton")
async def test_get_account_with_existing_account_id_and_valid_access_token_and_authenticating_user_does_not_exist_in_db(mock_redis_class, client, setup_initial_data):
...
@pytest.mark.asyncio
@patch("rbac_api.auth.impl.RedisSingleton")
async def test_get_account_with_nonexistent_account_id_and_valid_access_token_and_authenticating_user_exists_in_db(mock_redis_class, client, setup_initial_data):
