...
class ApikeyCreate(BaseModel):
   ...
   permissions: ApikeyScopedRBACPermission = Field(default = ApikeyScopedRBACPermission.create("Deny"))
   ...
   @classmethod
   def check_expires_at(cls, v : Union[datetime, Literal["NEVER"]]) -> Union[datetime, Literal["NEVER"]]:
      if v != "NEVER":
...
class ApikeyBaseResponse(BaseModel): # key field, cloned_user_id and cloned_apikey_id fields excluded
   id: uuid.UUID
   name: str
