...
class CreateProjectRouteParams(ExcludeAccountAndProjectParams): # /projects
   pass
class IngestServicenowTicketsRouteParams(ExcludeAccountAndProjectParams): # /servicenow/ingest 
   pass 
class GetApiKeysRouteParams(ExcludeAccountAndProjectParams): # /projects/{project_id}/apikeys
   pass
class CreateApiKeyRouteParams(ExcludeAccountAndProjectParams): # /projects/{project_id}/apikeys
   pass 
class GetDatasetsRouteParams(ExcludeAccountAndProjectParams): # /projects/{project_id}/datasets
   pass 
class TagDatasetRouteParams(ExcludeAccountAndProjectParams): # /projects/{project_id}/datasets -> not considering specfic dataset for tag permissions on general dataset resources
   pass 
class GetCollectionsRouteParams(ExcludeAccountAndProjectParams): # /projects/{project_id}/collection
   pass 
class CreateCollectionRouteParams(ExcludeAccountAndProjectParams): # /projects/{project_id}/collection
   pass 
class GetApplicationConfigurationsRouteParams(ExcludeAccountAndProjectParams): # /application/{application_id}/configuration
   application_id: int = Field(..., description = "ID of the application") 
class CreateApplicationConfigurationRouteParams(ExcludeAccountAndProjectParams): # /projects/{project_id}/configuration
   application_id: int = Field(..., description = "ID of the application") 
class UpdateApplicationConfigurationRouteParams(ExcludeAccountAndProjectParams): # /projects/{project_id}/configuration -> not considering specfic configuration for update permissions on general configuration resources
   application_id: int = Field(..., description = "ID of the application") 
class GetApplicationInstanceRouteParams(ExcludeAccountAndProjectParams): # /application/{application_id}/instance
   application_id: int = Field(..., description = "ID of the application") 
class CreateApplicationInstanceRouteParams(ExcludeAccountAndProjectParams): # /application/{application_id}/instance
   application_id: int = Field(..., description = "ID of the application") 
class UpdateApplicationInstanceRouteParams(ExcludeAccountAndProjectParams): # /application/{application_id}/instance -> not considering specfic instance for update permissions on general instance resources
   application_id: int = Field(..., description = "ID of the application")
class GetApplicationInstanceConfigurationsRouteParams(ExcludeAccountAndProjectParams): # /application/{application_id}/instance -> not considering specfic instance for configuration read permissions on general instance resources
   application_id: int = Field(..., description = "ID of the application")

class PermissionsEvaluationRequest(BaseModel): # the payload for the fields directly corresponds to the path params/header params for the GET ALL version of the endpoints (in other words, exclude target model id) without account/project in any order; this is because these are not exclusive to the target model id, and account/project is skipped because it is evaluated once in the endpoint for all the fields in payload for POST /auth/rbac-permissions
   ...
   INSTANCE_CONFIGURATION_READ: Optional[GetApplicationInstanceConfigurationsRouteParams] 
   ...
   def check_not_all_none(cls, values):
      ...
      if all(value is None for value in values.values()):
         print(f"Inside POST /auth/rbac-permissions - PermissionsEvaluationRequest root validator")
...
class EvaluatedPermissionsFactory:
   @staticmethod
   def get_evaluated_permission(all_permissions: bool, permission_field) -> EvaluatedPermission:
      match permission_field:
         ...
         case "PROJECT_SERVICENOW_TICKET_INGEST":
            return IngestServicenowTicketsEvaluatedPermission.create(all_permissions)
         case "APIKEY_READ":
         ...
         case "CONFIGURATION_READ":
            return GetApplicationConfigurationsEvaluatedPermission.create(all_permissions)
         case "CONFIGURATION_CREATE":
            return CreateApplicationConfigurationEvaluatedPermission.create(all_permissions)
         case "CONFIGURATION_UPDATE":
            return UpdateApplicationConfigurationEvaluatedPermission.create(all_permissions)
         case "INSTANCE_READ":
            return GetApplicationInstanceEvaluatedPermission.create(all_permissions)
         case "INSTANCE_CREATE":
            return CreateApplicationInstanceEvaluatedPermission.create(all_permissions)
         case "INSTANCE_CONFIGURATION_READ":
            return GetApplicationInstanceConfigurationsEvaluatedPermission.create(all_permissions)   
         case _:
            raise ValueError(f"Unsupported permission field: {permission_field}")

class PermissionsEvaluationResponse(BaseModel):
   IS_ACCOUNT_ADMIN: Union[IsAccountAdminEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   IS_PROJECT_ADMIN: Union[IsProjectAdminEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   APPLICATION_READ: Union[GetApplicationsEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   PROJECT_READ: Union[GetProjectsEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   PROJECT_CREATE: Union[CreateProjectEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   PROJECT_SERVICENOW_TICKET_INGEST: Union[IngestServicenowTicketsEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   APIKEY_READ: Union[GetApiKeysEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   APIKEY_CREATE: Union[CreateApiKeyEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   DATASET_READ: Union[GetDatasetsEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   DATASET_TAG: Union[TagDatasetEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   COLLECTION_READ: Union[GetCollectionsEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   COLLECTION_CREATE: Union[CreateCollectionEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   CONFIGURATION_READ: Union[GetApplicationConfigurationsEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   CONFIGURATION_CREATE: Union[CreateApplicationConfigurationEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   CONFIGURATION_UPDATE: Union[UpdateApplicationConfigurationEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   INSTANCE_READ: Union[GetApplicationInstanceEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   INSTANCE_CREATE: Union[CreateApplicationInstanceEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
   INSTANCE_CONFIGURATION_READ: Union[GetApplicationInstanceConfigurationsEvaluatedPermission, Literal['NOT_EVALUATED']] = Field(default='NOT_EVALUATED')
