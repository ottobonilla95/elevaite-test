...
def upgrade() -> None:
    ...
    op.execute(
        'UPDATE configurations SET "pipelineId" = (raw->>\'selectedPipelineId\')::uuid WHERE "pipelineId" is null'
    )
    op.alter_column(
        "configurations", "pipelineId", existing_type=sa.Uuid(), nullable=False
    )
    op.add_column("configurations", sa.Column("datasetId", sa.Uuid(), nullable=True))
    op.execute(
        'UPDATE configurations SET "datasetId" = (raw->>\'datasetId\')::uuid WHERE "datasetId" is null'
    )
    op.alter_column(
        "configurations", "datasetId", existing_type=sa.Uuid(), nullable=False
    )
    ...
    op.execute(
        'UPDATE instances SET "pipelineId" = "selectedPipelineId" WHERE "pipelineId" is null'
    )
    ...
    op.drop_constraint(
        "instances_selectedPipelineId_fkey", "instances", type_="foreignkey"
    )
    ...
    op.alter_column(
        "pipelines", "flyte_name", existing_type=sa.String(), nullable=False
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "pipelines", sa.Column("exit", sa.UUID(), autoincrement=False, nullable=False)
    )
    op.add_column(
        "pipelines",
    ...
    op.add_column(
        "pipelines", sa.Column("entry", sa.UUID(), autoincrement=False, nullable=False)
    )
    ...
    op.create_foreign_key(
        "pipelines_entry_fkey", "pipelines", "pipeline_steps", ["entry"], ["id"]
    )
    op.create_foreign_key(
        "pipelines_exit_fkey", "pipelines", "pipeline_steps", ["exit"], ["id"]
    )
    ...
    op.add_column(
        "instances",
        sa.Column("selectedPipelineId", sa.UUID(), autoincrement=False, nullable=False),
    )
    op.add_column(
        "instances",
    ...
    op.add_column(
        "instances",
        sa.Column("datasetId", sa.UUID(), autoincrement=False, nullable=False),
    )
    op.drop_constraint(None, "instances", type_="foreignkey")
    op.create_foreign_key(
        "instances_datasetId_fkey", "instances", "datasets", ["datasetId"], ["id"]
    )
    op.create_foreign_key(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["stepId"], ["pipeline_steps.id"], name="pipeline_step_data_stepId_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["pipelineId"], ["pipelines.id"], name="FKPipelineStepPipeline"
        ),
