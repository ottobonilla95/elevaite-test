...
def downgrade() -> None:
    ...
    try:
        op.create_unique_constraint(
            "uix_tool_name_version", "tools", ["name", "version"]
        )
    except Exception:
        pass  # Constraint might already exist or columns might not exist
    ...
    for column_name in columns_to_drop_in_downgrade:
        if column_name in existing_columns:
            op.drop_column("tools", column_name)
    op.alter_column(
