...
def upgrade() -> None:
    ...
    op.add_column("projects", sa.Column("account_id", postgresql.UUID(as_uuid=True), nullable=False))
    op.add_column("projects", sa.Column("project_owner_id", postgresql.UUID(as_uuid=True), nullable=False))
