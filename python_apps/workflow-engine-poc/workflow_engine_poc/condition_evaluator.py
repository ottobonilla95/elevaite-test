...
class ConditionEvaluator:
    ...
    def __init__(self):
        self.variable_pattern = re.compile(r'^([a-zA-Z_][a-zA-Z0-9_]*(?:\.[a-zA-Z_][a-zA-Z0-9_]*)*)')
    ...
    def evaluate_condition(self, condition: Condition, context: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if condition.operator == ConditionOperator.EQUALS:
                ...
                return self._safe_compare(left_value, condition.right_operand, lambda a, b: a > b)
                ...
                return left_value in condition.right_operand if condition.right_operand else False
            
            elif condition.operator == ConditionOperator.NOT_IN:
                return left_value not in condition.right_operand if condition.right_operand else True
    ...
    def evaluate_expression(self, expression: ConditionalExpression, context: Dict[str, Any]) -> bool:
        """
        ...
        try:
            ...
            if expression.logical_operator == LogicalOperator.AND:
                ...
                logger.warning(f"Unknown logical operator: {expression.logical_operator}")
                return False
    ...
    def parse_condition_string(self, condition_str: str) -> Optional[Condition]:
        ...
        try:
            ...
            if condition_str.strip().endswith(" is_not_empty"):
                ...
                return Condition(left_operand=left, operator=ConditionOperator.IS_NOT_EMPTY)
            ...
            if condition_str.strip().endswith(" is_not_null"):
                ...
                return Condition(left_operand=left, operator=ConditionOperator.IS_NOT_NULL)
