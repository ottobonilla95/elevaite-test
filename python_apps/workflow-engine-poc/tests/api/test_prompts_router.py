...
class TestCreatePrompt:
    ...
    def test_create_prompt_success(
        self, mock_guard, mock_get_session, mock_create, mock_session, sample_prompt
    ):
...
class TestListPrompts:
    ...
    @patch("workflow_engine_poc.routers.prompts.api_key_or_user_guard")
    @pytest.mark.api
    def test_list_prompts_no_filters(
        self, mock_guard, mock_get_session, mock_list, mock_session, sample_prompt
    ):
    ...
    @patch("workflow_engine_poc.routers.prompts.api_key_or_user_guard")
    @pytest.mark.api
    def test_list_prompts_empty_results(
...
class TestGetPrompt:
    ...
    def test_get_prompt_success(
        self, mock_guard, mock_get_session, mock_get, mock_session, sample_prompt
    ):
...
class TestUpdatePrompt:
    ...
    def test_update_prompt_success(
        self, mock_guard, mock_get_session, mock_update, mock_session, sample_prompt
    ):
...
class TestDeletePrompt:
    ...
    def test_delete_prompt_success(
        self, mock_guard, mock_get_session, mock_delete, mock_session, sample_prompt
    ):
