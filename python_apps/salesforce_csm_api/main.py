...
async def create_case(
    ...
    try:
        ...
        return CaseResponse(
            ...
            case_link=sf.generate_case_link(result['id'])
        )
...
async def get_case(
    ...
    try:
        ...
        # Add case link to the response
        result['case_link'] = sf.generate_case_link(case_id)
        return result
    except Exception as e:
...
async def update_case(
    ...
    try:
        ...
        return CaseResponse(
            ...
            case_link=sf.generate_case_link(case_id)
        )
    except Exception as e:
