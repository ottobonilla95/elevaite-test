...
#  TBD - Verify this works
# 1. Harris Teeter is the same as Kroger so refer to it as Kroger
# 2. Alternate tool use properly works
# 3. Make sure the part number response is always 7 or 11 digits number
